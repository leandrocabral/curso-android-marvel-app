...
class CharactersPagingSourceTest {
    ...
    private val charactersFactor = CharacterFactory()
    ...
    fun `should return a success load result when load is called`() =
        runBlockingTest {
            ...
            //Assert
            val expected = listOf(
                charactersFactor.create(CharacterFactory.Hero.TreedDMan),
                charactersFactor.create(CharacterFactory.Hero.ABomb)
            )
